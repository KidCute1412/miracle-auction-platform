...
const settings = vi.hoisted(() => ({ getAutoExtendTimeSetting: (_req: unknown, res: any) => res.json({ handler: "getAutoExtendTimeSetting" }) }));
...
describe("route contract: settings and dashboard", () => {
