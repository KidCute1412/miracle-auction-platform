...
describe("product use cases", () => {
  ...
  it("uploads product images and normalizes numeric form fields", async () => {
    ...
    expect(repo.postNewProduct).toHaveBeenCalledWith(expect.objectContaining({ seller_id: 7, step_price: 10, current_price: 100, cat2_id: 3, auto_extended: true, product_images: ["https://image.test/product.png"] }));
  });
