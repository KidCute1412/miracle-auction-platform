...
miracle-auction-platform.api.lok1412.site -> Hetzner EU VPS: Caddy, API, 3 workers, Redis
Supabase                                  -> PostgreSQL
Aiven Free                                -> Kafka
```
...
- In `Backend/.env.production`, set exactly `NODE_ENV=production`, `CLIENT_URL=https://auction.lok1412.site`, and `API_DOMAIN=miracle-auction-platform.api.lok1412.site`.
