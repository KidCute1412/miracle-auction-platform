...
export const HOURLY_THEMES: Record<number, HourlyTheme> = {
  ...
  1: {
    hour: 1,
    timeLabel: "01:00",
    name: "Cloud Nest Slumber Moon",
    category: "night",
    archetype: "cloud_moon",
    haloColors: ["#DDD6FE", "#8B5CF6", "#4C1D95"],
    coreColors: ["#FFFFFF", "#DDD6FE"],
    strokeColor: "#7C3AED",
    accentColor: "#EDE9FE",
    glowRgba: "rgba(124, 58, 237, 0.75)",
    dialogue: {
      text: "1 AM... Nestled warmly in fluffy clouds! ☁️💤",
      expression: "sleepy",
      symbol: "zzz",
    },
  },
  ...
  19: {
    hour: 19,
    timeLabel: "19:00",
    name: "Golden Evening Moon",
    category: "night",
    archetype: "evening_star",
    haloColors: ["#FDE047", "#F59E0B", "#B45309"],
    coreColors: ["#FEF08A", "#FBBF24"],
    strokeColor: "#B45309",
    accentColor: "#FDE047",
    glowRgba: "rgba(245, 158, 11, 0.6)",
    dialogue: {
      text: "7 PM! The Golden Moon has risen to greet the night! 🌕✨",
      expression: "happy",
      symbol: "sparkle",
    },
  },
  ...
  21: {
    ...
    glowRgba: "rgba(245, 158, 11, 0.6)",
    dialogue: {
      text: "9 PM! Savoring a warm cup of tea before sleep~ 🍵❤️",
      expression: "happy",
      symbol: "heart",
    },
  },
