      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-card/60 backdrop-blur-md border border-border p-5 rounded-2xl shadow-sm">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
          <button
            ...
            className={cn(
              "cursor-pointer inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold border transition-all duration-200 active:scale-95 shadow-sm w-full md:w-auto",
              product.is_removed
