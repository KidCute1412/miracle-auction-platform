          ...
          <div className="bg-card border border-border rounded-2xl p-6 shadow-sm space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-end gap-3 pt-4 border-t border-border/50">
              <button
                ...
                className="cursor-pointer inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-destructive/10 hover:bg-destructive/20 text-destructive text-sm font-semibold rounded-xl transition-all w-full sm:w-auto"
              >
                <Key className="w-4 h-4" /> Reset Password
              </button>
              <button
                onClick={handleSave}
                className="cursor-pointer inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-primary text-primary-foreground text-sm font-semibold rounded-xl hover:opacity-90 transition-all shadow-sm w-full sm:w-auto"
              >
