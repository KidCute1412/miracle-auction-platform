  ...
  return (
    <div className="bg-card border border-border/80 rounded-2xl p-4 shadow-sm transition-all duration-300">
      <div className="flex flex-col gap-4">
        ...
        {/* Row 2: Cascading Category Dropdown + Formatted VND Price Filter + Status Selector */}
        <div className="hidden md:flex flex-wrap gap-3 items-center justify-between pt-3 border-t border-border/40">
          <div className="flex flex-wrap gap-3 items-center">
            ...
            {/* Formatted VND Price Filter Popover / Box */}
            <div className="relative">
              ...
              {isPricePopoverOpen && (
                <div className="absolute left-0 top-full mt-2 w-96 max-w-[90vw] bg-card border border-border rounded-2xl p-4 shadow-xl z-30 animate-fadeIn">
                  <FormattedPriceInput
